<?php
    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if(empty($errores)) {
            ...
            $query = "INSERT INTO producto (title, descripcion, category, price, discountPercentage, brand, thumbnail) VALUES ('$title', '$descripcion', '$category', '$price', '$discountPercentage', '$brand', '$thumbnail')";
            var_dump($query);
